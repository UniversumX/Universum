...
def time_align_event_data_by_linearly_interpolating(event_data, eeg_data):
    """
    Takes in the event data and time-aligns it with eeg data by lineraly interpoalting the accelerometer data
    """
...
def get_data_from_run(subject_id, run_number):
    # Load data as CSV

    file_path = (
        f"../DataCollection/data2/{subject_id}/{subject_id}{run_number}.edf/"
    )
...
def get_data_from_directory(file_path: str):
