...
# Sample data
trial = 1
eeg_data_path = f"./data/103/1/1/eeg_data_raw.csv"
...
plt.scatter(tsne_embedding[:, 0], tsne_embedding[:, 1], c=timestamp_numeric, cmap='viridis', s=10)
plt.colorbar(label='Timestamp')
plt.title('t-SNE projection of FFT-transformed whitened data colored by timestamp')
plt.show()